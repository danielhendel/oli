/**
 * Reachability notes for destinations removed from the primary dock.
 *
 ...
 *
 * Deep links and internal cross-links remain intact.
 *
 * Roles (Stage 1B):
 * - Timeline: day-by-day record of what happened (not a competing home)
 * - Program: Weekly Progress + real workout-program entry (not My Plan yet)
 * - Library: provenance / lineage / replay (not a general education library)
 */

...
Optional public legal/support links (not secrets; required for Stage 1A acceptance when verifying legal access):

EXPO_PUBLIC_PRIVACY_POLICY_URL=https://...
EXPO_PUBLIC_TERMS_OF_SERVICE_URL=https://...
EXPO_PUBLIC_SUPPORT_URL=https://...

When unset, Privacy Policy / Terms / Support controls stay unavailable (no placeholder destinations).

...
**Merged baseline:** `b366744007bf771a0796f8499e9be224d226e6b6` (PR #219 Stage 3A; includes Stage 2 PR #217)
...
**Stage 3B branch:** `feat/body-composition-stage3b-value-first-shell` (**ACTIVE**; educational shell only)
...
- Stage 3B Body Composition value-first educational shell **ACTIVE** on branch (not complete; physical retest pending)
- Stage 3C Body provenance / baseline inputs **NOT BEGUN**
...
- Body Composition Stage 3B complete / merged educational shell (in progress on branch)
...
| **3B** | Body Composition value-first shell | Educational purpose, reference model, marker explanations, evidence tiers, baseline education, honest missing/partial, source/method education, links to existing actions — **ACTIVE** on `feat/body-composition-stage3b-value-first-shell`. No personalized rails, scores, aggregates, schema, Insights, or classification. Stage 3C **not begun**. |
...
**Current stage:** **Stage 3B ACTIVE** (value-first educational shell). Stage 3A **MERGED** (PR #219 at `b366744…`; Accepted 2026-09-18 with guardrails). Stage 3C **NOT BEGUN**.
...
**Stage 3B (ACTIVE — educational shell only):**
...
- Stage 3C: **NOT BEGUN**
- Complete claim: **not yet** (physical retest required)
...
R0 Product authority reset (docs) — MERGED (PR #211)
 ...
 → 3B Body Composition value-first shell — **ACTIVE** (`feat/body-composition-stage3b-value-first-shell`; educational shell only)
 → 3C Body baseline inputs + provenance — **NOT BEGUN**

...
import { on } from "@/lib/ui/eventBus"; // ⬅ optimistic refresh
...
export default function CardioDayScreen() {
  ...
  const { items, loading, error, reload } = useDayEvents("cardio", user?.uid, day);
  ...
  function handleClose() {
    router.replace("/(app)/(tabs)/cardio");
  }

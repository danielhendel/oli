...
const HEALTH_RECORD_CATEGORIES: HealthRecordCategory[] = [
  ...
  { id: "musculoskeletal", title: "Strength training", group: "Health Systems", recordState: "Implemented", route: "/(app)/workouts" },
  { id: "cardio-activity", title: "Cardio activity", group: "Health Systems", recordState: "Implemented", route: "/(app)/cardio" },

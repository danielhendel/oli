...
export default function RecoveryDayScreen() {
  ...
  const { items, loading, error, reload } = useDayEvents("recovery", user?.uid, day);
  ...
  function handleClose() {
    router.replace("/(app)/(tabs)/recovery");
  }

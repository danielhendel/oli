...
describe("mapRawEventToCanonical", () => {
    it("maps manual sleep payload to SleepCanonicalEvent", () => {
        ...
        if (!result.ok)
            throw new Error("Expected mapping success");
        ...
        if (canonical.kind !== "sleep")
            throw new Error("Expected sleep kind");
        const sleep = canonical;
    ...
    it("maps manual steps payload to StepsCanonicalEvent", () => {
        ...
        if (canonical.kind !== "steps")
            throw new Error("Expected steps kind");
        const stepsEvent = canonical;
    ...
    it("maps manual weight payload to WeightCanonicalEvent", () => {
        ...
        if (canonical.kind !== "weight")
            throw new Error("Expected weight kind");
        const weightEvent = canonical;
